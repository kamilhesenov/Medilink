...
namespace Medilink_Final_Project.Migrations
{
    ...
    [Migration("20201208191120_ShopClassPriceTypeMoneyDeleted")]
    partial class ShopClassPriceTypeMoneyDeleted
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medilink_Final_Project.Models.Checkout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Medilink_Final_Project.Models.ShopCkeckout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Medilink_Final_Project.Models.ShopCkeckout", b =>
                {
                    b.HasOne("Medilink_Final_Project.Models.Checkout", "Checkout")
                        .WithMany("ShopCkeckouts")
                        .HasForeignKey("CheckoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Medilink_Final_Project.Models.Shop", "Shop")
                        .WithMany("ShopCkeckouts")
